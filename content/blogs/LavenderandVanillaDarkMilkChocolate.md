---
title: "The Chocolate Log: Lavender and Vanilla Dark Milk Chocolate"
date: 2026-01-28
updated: 2026-01-28
description: "I recently got my hands on a melanger and have been trying my hand at chocolate making. Only after starting this hobby, I found out that there are very few sources on the internet for home-scale chocolate making. Thankfully, we have The Chocolate Alchemist, whose giant shoulders I can stand on as I learn how this process works. However, with such a lack of knowledge on the internet, I figure this is my chance to add to the Internet's knowledge base."
tags:
  - FoodAndDrink
  - Culture
  - Chocolate
...
<div style="display: flex; gap: 10px; align-items: center;">
  <img src="../Assets/45a7eb8f40ae9775e4be58c2fff2f6e2.jpg" style="width: 33%; height: auto;" alt="Chocolate making process">
  <img src="../Assets/5be89cba9ceccbc14b636c7d684a57c6.jpg" style="width: 33%; height: auto;" alt="Chocolate making process">
  <img src="../Assets/1961a0d4a8316a3c64b3bbe690fbad3a.jpg" style="width: 33%; height: auto;" alt="Chocolate making process">
</div>
...
<div style="text-align: center;">
  <img src="../Assets/b521da4c01682efdf3c010396779beda.jpg" style="max-height: 400px; width: auto;" alt="Cocoa nibs">
</div>
...
<div style="display: flex; gap: 10px; align-items: stretch;">
  <img src="../Assets/6110cdc1035911538c7513cedf6799a8.gif" style="width: 50%; height: 400px; object-fit: cover; object-position: center;" alt="Grinder process">
  <img src="../Assets/388539f62e608454049609f52431c11d.jpg" style="width: 50%; height: 400px; object-fit: cover; object-position: center;" alt="Chocolate ready to temper">
</div>
...
<div style="display: flex; gap: 10px; align-items: stretch;">
  <img src="../Assets/d6c6714ab6adee0e857aad26d4438f3d.gif" style="width: 50%; height: 450px; object-fit: cover; object-position: center;" alt="Final chocolate results">
  <img src="../Assets/204bd84b6cf9f2b4d4ed6a6c17ba7e43.gif" style="width: 50%; height: 450px; object-fit: cover; object-position: center;" alt="Final chocolate results">
</div>
...
<style>
  ...
  @media (max-width: 700px) {
    #recipe-card,
    #recipe-card * { box-sizing: border-box; }
    #recipe-card { flex-direction: column; gap: 1rem; margin: 1.5rem 0; }
    #recipe-card > div { width: 100% !important; min-width: 0 !important; flex: 1 1 100% !important; }
    #recipe-card table { width: 100%; table-layout: fixed; }
    #recipe-card td { word-break: break-word; overflow-wrap: anywhere; }
  }
</style>

<div id="recipe-card" style="display: flex; gap: 2rem; margin: 2rem 0; flex-wrap: wrap; align-items: flex-start;">
  <div style="flex: 1; min-width: 250px; background: var(--color-bg-medium); border-radius: 8px; padding: 1.5rem; border: 1px solid var(--ctp-surface1);">
  ...
  <div style="flex: 2; min-width: 400px; background: var(--color-bg-medium); border-radius: 8px; padding: 1.5rem; border: 1px solid var(--ctp-surface1);">
