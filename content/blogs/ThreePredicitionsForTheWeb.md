---
title: Three Predictions For The Web
date: 2025-12-03
updated: 2025-12-03
description: "My submission for the December 2025 IndieWeb Carnival"
...
tags:
    ...
    - IndieWebCarnival
    - IndieWeb
    - IndieWebCarnivalDecember2025
---

![](../Assets/103f5d4edd01e5938368d62f126766c7.png)
[KMCD Visualizing The Internet](https://kmcd.dev/posts/internet-map-2025/)


The theme for this months [IndieWeb Carnival](https://indieweb.org/IndieWeb_Carnival) is [**where do you see the IndieWeb in 2030**](https://vhbelvadi.com/indieweb-carnival-future) and is hosted by [V.H Belvadi](https://vhbelvadi.co). I thought this was a great  excuse to yap about my politics, what I want to see in the world (and what I think will actually happen).  So I am making three predictions. What I would **like** to see in the next 5 years, what I **expect** to happen, and what I think the **biggest risks are**. I'm not sure what portion of my readers are famiiar with the "IndieWeb" as a concept, vs how many I have from the IndieWeb. 
...
To shove a hamfisted music metaphor in there, it is kind of like the realtionship between dance-punk and postpunk. Where every 20 years, people remember that dance-punk is a thing and it breaks out of the postpunk scene growing as its own microgenre, before re-merging back into the postpunk scene. [Middle 8 has a great video essay about the historyof the subgenre and this phenomenon](https://m.youtube.com/watch?v=QAAekkeN3r0&pp=ygUKZGFuY2UgcHVuaw%3D%3D)
...
To quote Starbreaker speaking on the topic of the [Indieweb as a concept](https://starbreaker.org/grimoire/entries/has-indieweb-become-irrelevant/index.html#update-2024-08-29): 

---

> *I don't particularly like the fact that we seem to need so many names for what I think ought to be the default. In my opinion, sites like this one, [fyr.io](https://fyr.io), and even Neocities and [omg.lol](https://omg.lol) are the World Wide Web. Sites like Facebook, Amazon, YouTube, LinkedIn, and Twitter are the _corporate Web_. They're parasitic abberations, walled gardens gentrifying the internet, and an attempt by business people to turn the internet into cable TV with a comments section. We should not accept the premise that _they_ are what the web is or should be.*
